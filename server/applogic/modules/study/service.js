...
module.exports = {
	...
	graphql: {
		...
		query: `
			posts(limit: Int, offset: Int, sort: String): [Question]
		...
		mutation: `
			postCreate(title: String!, content: String!): Question
			postUpdate(code: String!, title: String, content: String): Question
			postRemove(code: String!): Question

			postVote(code: String!): Question
			postUnvote(code: String!): Question
		`,
